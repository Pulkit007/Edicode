...
import Draft from "../../PlayGround/RichEditor/Draft";
        ...
        <div className="z-100">
              ...
              {this.state.addClass ? (
                <button onClick={this.toggle.bind(this)}>
                  <svg
                    ...
                    width="31.5"
                    height="36.952"
                    viewBox="0 0 31.5 36.952"
                  >
                    <path
                      id="Icon_awesome-sticky-note"
                      data-name="Icon awesome-sticky-note"
                      d="M9.563,15.447H0V37.223A1.847,1.847,0,0,0,1.688,39.2H29.813a1.847,1.847,0,0,0,1.688-1.98V4.23a1.847,1.847,0,0,0-1.687-1.98H11.25V13.468A1.857,1.857,0,0,1,9.563,15.447ZM.492,10.911,7.383,2.827a1.57,1.57,0,0,1,1.2-.577H9V12.808H0v-.5A2.159,2.159,0,0,1,.492,10.911Z"
                    ...
                    <rect
                      ...
                      height="21.008"
                      rx="1.501"
                      transform="matrix(0.839, -0.545, 0.545, 0.839, 8.771, 12.164)"
                      fill="#818181"
                    />
                    <rect
                      id="Rectangle_52"
                      ...
                      height="21.008"
                      rx="1.501"
                      transform="translate(20.873 11.199) rotate(37)"
                      fill="#818181"
                    />
                  </svg>
                </button>
          ...
          <div className="tools-section">
            ...
            <div className="brushsize-container">
              <label>Size :</label>
              <span
                className="pen-color-container"
                onClick={this.blackPan.bind(this)}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24.867"
                  height="24.866"
                  viewBox="0 0 24.867 24.866"
                >
                  <path
                    id="Icon_awesome-pen"
                    data-name="Icon awesome-pen"
                    d="M14.12,4.529l6.218,6.218-13.5,13.5-5.544.612A1.166,1.166,0,0,1,.007,23.572l.617-5.547,13.5-13.5ZM24.184,3.6,21.264.684a2.332,2.332,0,0,0-3.3,0L15.219,3.43l6.218,6.218L24.184,6.9a2.332,2.332,0,0,0,0-3.3Z"
                    transform="translate(0.001 -0.001)"
                  />
                </svg>
              </span>
              <span
                className="eraser-color-container"
                onClick={this.eraseHandler.bind(this)}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="26.222"
                  height="22.944"
                  viewBox="0 0 26.222 22.944"
                >
                  <path
                    id="Icon_awesome-eraser"
                    data-name="Icon awesome-eraser"
                    d="M25.5,14.641a2.458,2.458,0,0,0,0-3.477L17.308,2.97a2.458,2.458,0,0,0-3.477,0L.72,16.081a2.458,2.458,0,0,0,0,3.477l4.917,4.917a2.459,2.459,0,0,0,1.738.72H25.607a.615.615,0,0,0,.615-.615V22.531a.615.615,0,0,0-.615-.615H18.226L25.5,14.641ZM10,11.434l7.036,7.036-3.447,3.447H7.714l-4.1-4.1L10,11.434Z"
                    transform="translate(0 -2.25)"
                    fill="#cbcbcb"
                  />
                </svg>
